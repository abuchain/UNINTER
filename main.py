...
def cadastrarPeca(indice):  # METODO PARA CADASTRAR PEÇAS
    ...
    while True:  # INICIO DO LOOP PARA O MENU
        ...
        peca = {'codigo': str(_codigo), 'nome': _nome, 'fabricante': _fabricante,
                'valor': _valor}  # CRIAÇÃO DE UM DICIONARIO COM OS VALORES COLETADOS
...
# PROGRAMA PRINCIPAL
_4499559 = 'BEM VINDO AO CONTROLE DE ESTOQUE DA BICICLETARIA DE MARCELO EDUARDO ABUCHAIN : RU 4499559 '  # IDENTIFICAÇÃO PESSOAL
...
while True:  # INICIO DO LOOP PARA O MENU
    ...
    if opcao == '1':
        cadastrarPeca(
            proximoCodigoPeca())  # ACIONANDO METODO DE CADASTRAR PEÇA E PASSANDO O CODIGO PARA CADASTRO DA PRÓXIMA PEÇA
    elif opcao == '2':
